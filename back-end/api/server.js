...
const { listProducts, adminProfile, register, login, ordersAdmin, getOneOrderAdmin } = require('./routes');
...
apiTrybeer.get('/admin/orders/:id', databaseErrorHandling(getOneOrderAdmin));
