...
class OrderRepository {
  ...
  static async _formatDate(orders) {
  ...
  static async _updateStatus(statusOrder) {
  ...
  // Client
  static async getListOrderClient(token) {
  ...
  static async _createProductOrder(idOrder, orders) {
